...
export const Default = (args: Properties): TemplateResult => {
    return html`
        ...
        <sp-tabs selected="1" ?auto=${args.auto}>
...
export const Autofocus = (args: Properties): TemplateResult => {
    return html`
        <sp-tabs selected="1" autofocus ?auto=${args.auto}>
...
export const Vertical = (args: Properties): TemplateResult => {
    return html`
        <sp-tabs selected="1" direction="vertical" ?auto=${args.auto}>
            <sp-tab label="Tab 1" value="1"></sp-tab>
            <sp-tab label="Tab 2" value="2"></sp-tab>
            <sp-tab label="Tab 3" value="3"></sp-tab>
            <sp-tab label="Tab 4" value="4"></sp-tab>
...
export const VerticalRight = (args: Properties): TemplateResult => {
    return html`
        ...
        <sp-tabs selected="1" direction="vertical-right" ?auto=${args.auto}>
            <sp-tab label="Tab 1" value="1"></sp-tab>
            <sp-tab label="Tab 2" value="2"></sp-tab>
            <sp-tab label="Tab 3" value="3"></sp-tab>
            <sp-tab label="Tab 4" value="4"></sp-tab>
